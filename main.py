...
class ToDoApp(MDApp):
    ...
    def add_todo(self, title, description):
        if title != "" and description != "" and len(title) < 21 and len(description) < 61:
            ...
            Snackbar(text="Title is missing!", snackbar_x="10dp", snackbar_y="10dp", sie_hint_y=.08,
            size_hint_x=(Window.width - (kivy.metrics.dp(10) * 2)) / Window.width, bg_color=(1, 170/255, 23/255, 1),
            font_size="18sp").open()
        
        elif description == "":
            Snackbar(text="Description is missing!", snackbar_x="10dp", snackbar_y="10dp", sie_hint_y=.08,
            size_hint_x=(Window.width - (kivy.metrics.dp(10) * 2)) / Window.width, bg_color=(1, 170/255, 23/255, 1),
            font_size="18sp").open()
